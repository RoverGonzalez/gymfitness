...
function gymFitness_scripts_styles() {
    ...
    if(is_front_page()){
        wp_enqueue_style('swiper-css', 'https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css', array(), '9.0.5');
    }
    ...
    if(is_front_page()){
        wp_enqueue_script('swiper-js', 'https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js', array(), '9.0.5', true);
...
function gymfitness_ubicacion_shortcode() {
    ...
    <?php
    echo do_shortcode('[contact-form-7 id="94" title="Formulario de contacto 1"]');
}
